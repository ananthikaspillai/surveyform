...
//             const survey = response.data.find((survey) => survey.id === parseInt(localStorage.getItem('surveyid')));
//             if (survey) {
//                 console.log('Survey details retrieved successfully', survey);
//                 setSurveyCount(survey.surveyCount);
//             } else {
//                 console.error('Survey not found');
//             }
//         } catch (error) {
//             console.error('Failed to retrieve survey details', error);
//         }
//     };
...
//         <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-emerald-400 to-gray-200 py-12 px-4">
//             <div className="w-[800px] space-y-10 bg-gradient-to-r from-zinc-300 to-zinc-100 p-10 rounded-lg shadow-md">
//                 <h1 className="text-3xl text-center font-bold mb-4 bg-teal-600 pt-[45px] pb-[45px] rounded-lg text-white">
//                     Hey Submit the Survey
//                 </h1>
//                 <p className="font-bold mb-4 text-lg">Survey Count: {surveyCount}</p>
//                 {questionsAndOptions.map((question) => (
//                     <div key={question.id} className="mb-8 border rounded p-4 text-black">
//                         <p className="font-bold mb-4 text-lg">{question.question}</p>
